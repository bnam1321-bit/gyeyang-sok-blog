...
const mainServices = [
    ...
    { 
        title: '영상진단 센터', 
        desc: '정밀 CT(컴퓨터 단층촬영) 장비와 고해상도 초음파를 활용하여 보이지 않는 장기까지 정밀하고 안전하게 진단합니다.', 
        icon: '🧪', 
        color: 'bg-blue-500' 
    },
];
            ...
            <section className="bg-primary py-24 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    <p className="text-xl text-slate-300 max-w-3xl mx-auto break-keep font-medium leading-relaxed">
                        인천계양속편한내과는 정밀 최상위 내시경 장비인 <span className="text-white font-black">올림푸스 CV-290</span>과 <span className="text-white font-black">정밀 CT 촬영 장비</span>를 보유하고 있으며, 6인 전문의의 협진으로 수준 높은 진료 서비스를 제공합니다.
                    </p>
                </div>
            </section>
