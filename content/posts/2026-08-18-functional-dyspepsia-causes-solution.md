...
기능성 소화불량 환자의 위장 속에서는 다음과 같은 복합적인 기능 장애가 일어나고 있습니다.
...
[ 자율신경계 실조 (교감신경 항진) ]
           ↓
┌───────────────────────────────┬───────────────────────────────┐
│ 1. 위 순응 장애 (음식 수용 불가)  │ 2. 위 배출 지연 (음식물 정체)    │
│ 3. 내장 감각 과민 (작은 자극에 통증)│ 4. 뇌-장 축(Brain-Gut Axis) 교란 │
└───────────────────────────────┴───────────────────────────────┘
           ↓
[ 만성 명치 답답함, 조기 포만감, 속쓰림, 체기 ]
```
