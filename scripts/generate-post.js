...
async function generatePost() {
    ...
    if (process.argv[2]) {
        ...
        try {
            ...
            - 정밀 MDCT 정밀 검사 (일반 로컬 의원 중 매우 드문 CT 보유의 강점 강조: 대형병원 대기 없이 당일 신속 두통/뇌 CT, 가슴/심장/폐 CT, 복부/췌장/담석 CT 촬영 및 판독)
...
- **어조**: 진료실에서 환자에게 설명하듯 표현("저희 의원에 오시는 분들 중...")을 자연스럽게 일부 사용하세요. 특정 개인이나 원장님을 명시적으로 지칭하지 않도록 주의하세요.
